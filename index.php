...
<body>
    ...
    <header class="bg-dark">
        <div
            class="container-fluid bg-container text-center text-white d-flex align-items-center justify-content-center">
            <div class="text-center text-white">
                <h1 class="display-5 fw-bolder glow-text-blue">DOMINATE WITH THE BEST</h1>
                <p class="lead fw-normal text-white-50 mb-0 glow-text-blue">CUSTOM PC'S WITH WORLD CLASS HARDWARE</p>
            </div>
        </div>
    </header>
    <!-- Section-->
